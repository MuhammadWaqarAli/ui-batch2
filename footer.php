...
<div class="container-fluid footer">
	<div class="row text-center text-sm-left text-md-left ">
		...
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 links-heading" >
			...
			<ul class="unstyle-list">
				...
				<li>
					<a href="#"> <i class="fas fa-angle-double-right"></i> PosrtFollio</a>
				</li>
				<li>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-white text-center ">
			<p class="footer-link"><a href="http://www.uilearning.com/" target="_blank" >Webdevelopment.com</a> Copyright reserve 2018 </p>
